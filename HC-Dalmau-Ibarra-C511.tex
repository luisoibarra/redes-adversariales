...
redes neuronales artificiales\citep{wikipercept}.
...
perceptrón Mark I en 1960\citep{wikifrank}.
...
inferiores\citep{wikimultilayer}.
...
función de activación\citep{wikilogit}.
\\
\\
...
de Adolphe Quetelet\citep{wikipierre}.
...
principal asesor científico del Vector Institute en Toronto\citep{wikigeoffrey}.
...
podía crear fotos por sí mismo\citep{techreview}.
...
%
%
%\bibitem[WIKI GAN]{wikigan}\href{https://es.wikipedia.org/wiki/Red_generativa_antagónica}{Wikipedia Redes Antagónicas}
%
%\bibitem[RAPIDMINER]{rapidminer}
%\href{https://rapidminer.com/glossary/generative-adversarial-networks}{Sitio de Rapid Miner}
%
%\bibitem[TECHREVIEW]{techreview}
% \href{https://www.technologyreview.com/2018/02/21/145289/the-ganfather-the-man-whos-given-machines-the-gift-of-imagination/}{Sitio deTechnology Review}
%
%\bibitem[PUENTESDIGIT]{puentesdigit}
%\href{https://puentesdigitales.com/2019/04/05/todo-lo-que-necesitas-saber-sobre-las-gan-redes-generativas-antagonicas/}{Sitio de Puentes Digitales}
%
%
%\bibitem[WIKI LOGIT]{wikilogit}
%\href{https://en.wikipedia.org/wiki/Logistic_regression}{Wikipedia Regresión Logística}
%
%\bibitem[WIKI PERCEPT]{wikipercept}
%\href{https://es.wikipedia.org/wiki/Perceptr\%C3\%B3n}{Wikipedia Perceptrón}
%
%\bibitem[WIKI MULTILAYER]{wikimultilayer}
%\href{https://es.wikipedia.org/wiki/Perceptr\%C3\%B3n_multicapa}{Wikipedia Perceptrón Multicapas}
%
%\bibitem[WIKI FRANK]{wikifrank}
%\href{https://es.wikipedia.org/wiki/Frank_Rosenblatt}{Wikipedia Frank Rosenblatt}
%
%\bibitem[WIKI YANN]{wikiyann}
%\href{https://es.wikipedia.org/wiki/Yann_LeCun}{Wikipedia Yann LeCun}
%
%\bibitem[WIKI GEOFFREY]{wikigeoffrey}
%\href{https://en.wikipedia.org/wiki/Geoffrey_Hinton}{Wikipedia Geoffrey Hinton}
%
%\bibitem[WIKI PIERRE]{wikipierre}\href{https://en.wikipedia.org/wiki/Pierre_Fran\%C3\%A7ois_Verhulst}{Wikipedia Pierre Francois Verhulst}
%
%\bibitem[A BRIEF HISTORY]{history}\href{https://www.skynettoday.com/overviews/neural-net-history}{A Brief History of Neural Nets and Deep Learning}
%
%\end{thebibliography}
\newpage

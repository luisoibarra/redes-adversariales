...
\newpage
\begin{abstract}
	IA, Redes Neuronales, Redes Generativas Adversariales, RGA, GAN, AI, Neural Networks, 
  Generative Adversarial Networks.
\end{abstract}

`` Al enfrentar las redes neuronales entre sí, Ian Goodfellow ha creado una poderosa 
herramienta de IA. Ahora él y el resto de nosotros, debemos afrontar las consecuencias.``
...
Las redes generativas adversariales o redes generativas antagónicas son un caso particular 
de las redes neuronales nacidas en el siglo XX.
